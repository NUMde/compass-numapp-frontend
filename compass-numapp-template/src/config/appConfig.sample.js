...
const conf = {
  ...
  // 	"SubjectId":	"subjectId"
  // }
  // the attribute-names necessary to check the appIdentifier and to extract the subjectId
  ...
  localStorageMap: `@${appName}_STORE:persisted_survey`,

  /** local storage identifier:
   * persists the questionnaireItemMap */
  localStorageList: `@${appName}_STORE:persisted_survey_list`,

  /** local storage identifier:
   * the subject-id of the user last logged in */
  lastSubjectId: `@${appName}_STORE:last_active_user`,

  /** local storage identifier:
   * the id of the last active questionnaire of the last active user */
  lastQuestionnaireId: `@${appName}_STORE:last_questionnaire_id`,

  /** local storage identifier:
   * persists all relevant information about the notification-service */
  FCMToken: `@${appName}_STORE:fcm_token`,

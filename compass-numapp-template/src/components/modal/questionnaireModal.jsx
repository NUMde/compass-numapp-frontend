    ...
    return this.getRenderStatusOfItem(item) ? (
      <View>
        ...
        <Text
          ...
          accessibilityHint={strings.accessibility.questionnaire.singleChoice}
          style={{
          ...
          <View>
            ...
            {item.type === 'open-choice' && (
              <Input
                placeholder={
                  item.repeats
                    ? strings.survey.additionalAnswer
                    : strings.survey.alternativeAnswer
                }
                value={this.procureOpenAnswer(item)}
                accessibilityHint={
                  strings.accessibility.questionnaire.textFieldHint
                }
                onChangeText={(text) => {
                  // sets the answer
                  actions.setAnswer({
  ...
  createOpenChoices = (item) => {
    ...
    return this.getRenderStatusOfItem(item) ? (
      <View>
        ...
        <Text
          accessibilityLabel={item.text}
          accessibilityHint={strings.accessibility.questionnaire.multipleChoice}
          style={{
            ...localStyle.contentTitle,
            fontSize: this.calculateFontSize(item.linkId),
            marginLeft: this.calculateIndent(item.linkId),
  ...
  createInput = (item) => {
    ...
    return this.getRenderStatusOfItem(item) ? (
      <View style={localStyle.modalInput}>
        ...
        {/* input */}
        <Input
          placeholder={strings.login.inputPlaceholder}
          ...
          // accessibilityLabel={ }
          accessibilityHint={strings.accessibility.questionnaire.textFieldHint}
          onChangeText={(text) => {
      ...
      <View style={localStyle.modalInput}>
        ...
        {/* android datepicker */}
        {
          <TouchableOpacity
            ...
            // accessibilityHint={strings.accessibility.questionnaire.dateFieldHint}
          >
            <Input
              placeholder={strings.login.inputPlaceholderTime}
              value={
                questionnaireItemMap[item.linkId].answer
        ...
        {Platform.OS === 'ios' && showDatePicker && (
          <View style={localStyle.dateTimePickerButtonBar}>
            <Button
              ...
              type="clear"
              titleStyle={{ color: theme.colors.accent4 }}
            />
            <Button
      ...
      <View style={localStyle.modalInput}>
        ...
        <Slider
          ...
          accessibilityHint={
            ...
            strings.accessibility.questionnaire.sliderFieldEquals +
            sliderProperties.LowRangeLabel +
            strings.accessibility.questionnaire.sliderFieldAnd +
          ...
          <View style={localStyle.modalViewWrapper}>
            <View>
              <Text
                ...
                accessibilityRole={strings.accessibility.types.header}
              >
    ...
    return (
      ...
      >
        {appConfig.useProgressBar && (
          <ProgressBar
            progress={
              appConfig.useStrictModeProgressBar
        ...
        <View style={localStyle.bottomBarButtons}>
          ...
          {currentPageIndex > 1 && (
            <Button
              ...
              accessibilityRole={strings.accessibility.types.button}
              accessibilityHint={
                strings.accessibility.questionnaire.leftButtonHint
              }
              onPress={() => {
                setAccessibilityResponder(this.modalTitleRef);
          ...
          <Button
            ...
            accessibilityLabel={
              this.checkCurrentPageState()
                ? strings.accessibility.questionnaire.middleButtonFinished
                : strings.accessibility.questionnaire.middleButtonUnfinished
            }
            accessibilityRole={strings.accessibility.types.button}
            accessibilityHint={
              strings.accessibility.questionnaire.middleButtonHint
            }
            onPress={() => {
              setAccessibilityResponder(this.modalTitleRef);
              this.lastPageNavigationWasForwards = true;
          ...
          {currentPageIndex < categories[currentCategoryIndex].item.length && (
            <Button
              ...
              accessibilityRole={strings.accessibility.types.button}
              accessibilityHint={
                strings.accessibility.questionnaire.rightButtonHint
              }
              onPress={() => {

    ...
    return (
      ...
      >
        ...
        <View style={localStyle.bottomBarWrapper}>
          ...
          <Button
            type="clear"
            accessibilityLabel={strings.accessibility.accept}
            accessibilityRole={strings.accessibility.types.button}
            accessibilityHint={strings.accessibility.acceptHint}
            onPress={() => {
          ...
          {this.isAccessibilityOn && (
            <Button
              type="clear"
              accessibilityLabel={strings.accessibility.cancel}
              accessibilityRole={strings.accessibility.types.button}
              accessibilityHint={strings.accessibility.closeHint}
              onPress={() => {
                actions.hideModal();
              }}
              icon={

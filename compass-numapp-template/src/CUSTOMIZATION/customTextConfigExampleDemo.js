...
export default {
  ...
  reporting: {
    ...
    symptoms_question:
      'This special report can only be sent out while no other questionnaire is available. Do you want to proceed (the data is NOT sent anywhere)?',
  },

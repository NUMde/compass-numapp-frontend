                ...
                <View style={{ ...localStyle.flexi, ...localStyle.wrapper }}>
                  <View>
                    ...
                    <QRCodeScanner
                      ...
                      permissionDialogMessage={strings.login.permissionDialog}
                    />
                  </View>

                  {/* information text */}
                  <Text style={localStyle.infoText}>
                    {strings.login.qrInfo}
                  </Text>
                  ...
                  {loginError && (
                    <View>
                      ...
                      {loginUnauthorized && (
                        ...
                        >
                          {strings.login.errorUserUnauthorized}
                        </Text>
                      )}
                      ...
                      {!loginUnauthorized && (
                        <View>
                          ...
                          >
                            {loginError?.message ??
                              strings.login.errorUserGeneric}
                            {'\n'}
                            {strings.login.nextStepAfterError}
                          </Text>
                        </View>
                      )}
                    </View>

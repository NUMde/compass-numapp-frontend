...
const persistFCMToken = async (FCMToken, subjectId) => {
  ...
  try {
    await EncryptedStorage.setItem(`${appConfig.FCMToken}_${id}`, FCMToken);
  } catch (error) {
    console.error(error);
  }
};
...
const removeLastQuestionnaireId = async (subjectId) => {
  ...
  try {
    await EncryptedStorage.removeItem(`${appConfig.lastQuestionnaireId}_${id}`);
  } catch (error) {
    console.error(error);
  }
};
...
const loadCategories = async (subjectId) => {
  ...
  try {
    return JSON.parse(
      await EncryptedStorage.getItem(`${appConfig.localStorageList}_${id}`),
    );
  } catch (error) {
    console.error(error);
    return null;
...
const removeCategories = async (subjectId) => {
  ...
  try {
    await EncryptedStorage.removeItem(`${appConfig.localStorageList}_${id}`);
  } catch (error) {
    console.error(error);
  }
};
...
const loadQuestionnaireItemMap = async (subjectId) => {
  ...
  try {
    return JSON.parse(
      await EncryptedStorage.getItem(`${appConfig.localStorageMap}_${id}`),
    );
  } catch (error) {
    console.error(error);
    return null;
...
const removeQuestionnaireItemMap = async (subjectId) => {
  ...
  try {
    await EncryptedStorage.removeItem(`${appConfig.localStorageMap}_${id}`);
  } catch (error) {
    console.error(error);
  }
};

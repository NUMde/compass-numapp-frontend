  ...
  render() {
    ...
    return (
      <View style={localStyle.container}>
        {Platform.OS === 'ios' && (
          <StatusBar barStyle={theme.values.StatusBarStyleIos} />
        )}

        {Platform.OS === 'android' && (
          <StatusBar
            barStyle={theme.values.StatusBarStyleAndroid}
            backgroundColor={theme.values.StatusBarAndroidBackgroundColor}
          />
        )}

...
cd ..
mkdir ./assets/files && curl https://raw.githubusercontent.com/NUMde/compass-implementation-guide/master/input/questionnaire-generic.json > ./assets/files/questionnaire.json

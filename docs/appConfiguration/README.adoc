...
----
The Login Options containt the attribute-names necessary to check the appIdentifer and to extract the subjectId. This way you can generate QR Code that contain your own AppIdentifier.
--

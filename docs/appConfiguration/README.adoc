...
== Kiosk Mode
The following option activates a demonstration mode. While in this mode, no communication with the/a Compass Backend will occur. All features are working as designed, jsut with mock data.

* *kioskMode:*
** sets the app up to be a demo client.

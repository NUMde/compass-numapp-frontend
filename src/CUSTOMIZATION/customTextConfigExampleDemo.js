...
// This files contains an example of application strings that can be used for a demo build.
// it is not included by any file, it really is jsut an example.
...
export default {
    ...
    about: {
      ...
      demoDelete: "Delete all & logout\n(just for this DEMO - this button is NOT accessible in a productive version)",
    ...
    survey: {
      ...
      welcomeTextFirstTimeUser2:
        " - See?",
      sendFinishedMessage:
        "Only a completed questionnaire can be sent out. So far so good. Are you sure you want to simulate now the (fully encrypted) transmission of your answers (the data is NOT sent anywhere)?",
      ...
      furtherInfo:
        "(In this particular case the time is not determined by an actual server running a study, as this is just a DEMO.)",
      welcomeTextUser:
    ...
    reporting: {
      ...
      symptoms_question: "This special report can only be sent out while no other questionnaire is available. Do you want to proceed (the data is NOT sent anywhere)?",
    },

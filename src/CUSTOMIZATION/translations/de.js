export default {
    ...
    accessibility: {
      ...
      refreshHint: "Holen Sie sich den Fragebogen und den Status neu.Die aktuelle Seite wird aktualisiert.",
      ...
      accept: "annehmen",
      cancel: "Abbrechen",
      acceptHint: "Wechselt in die Standard-Browser-Anwendung und öffnet dort Link.",
      ...
      questionnaire: {
        ...
        middleButtonUnfinished: "Nächste Frage, obwohl die Frage noch nicht beantwortet wird.",
        middleButtonHint: "Springt zu den nächsten Fragen oder schließt das Modal, wenn dies die letzte Frage war.",
  
        rightButtonHint: "Schließt das Modal.",
        leftButtonHint: "Springt zur vorherigen Frage.",
        alertButtonHint: "Schließt den Alarm.",
  
        questionnaireCellHint: "Öffnet neue Seite, um die Kategorien der Fragebogen anzuzeigen.",
        categoryCellHint: "Öffnet MODAL, um diesen Fragebogeneintrag auszufüllen.",
        category: "Diese Kategorie",
        questionnaire: "Dieser Fragebogen",
        notStarted: "wurde noch nicht beantwortet.",
        notFinished: "wurde bereits gestartet, ist aber noch nicht vollständig ausgefüllt.",
        finished: "ist vollständig vollständig.",
  
        sendHint: "Sendet den Fragebogen an die Bewertung.",
  
        multipleChoice: "Multiple Choice - mehr als eine Antwortoption kann ausgewählt werden.",
        singleChoice: "Einzelne Wahl - Nur eine Antwort-Option kann ausgewählt werden.",
        textFieldHint: "Bitte füllen Sie hier die angeforderten Informationen aus.",
        dateFieldHint: "Öffnet ein neues Modal, um ein Datum auszuwählen.",
        sliderFieldEquals: "entspricht",
        sliderFieldAnd: ", und",
  
        triggerHint: "Wenn dieses Element ausgewählt ist, wird eine weitere zusätzliche Frage angezeigt, die mit diesem Element verbunden ist.Bitte füllen Sie auch die zusätzliche Frage aus.",
      },
    },
    ...
    login: {
      ...
      permissionDialog: "Bitte erlauben Sie der App, auf Ihre Kamera zuzugreifen.",
    ...
    generic: {
      ...
      sendError: "Es gab einen Fehler, der die Daten übermittelt.Bitte versuche es erneut.",
      sendErrorTwoDevices: "Sie haben diesen Fragebogen bereits durch eine andere App gesendet.",
      ...
      reportWhileQuestionnaire: "Dialog, um dem Benutzer mitzuteilen, dass derzeit ein Fragebogen zur Verfügung steht und dass er das verwenden könnte, um über seinen Zustand zu berichten.",
    },
    ...
    about: {
      ...
      languageWarning: "Wenn Sie die Sprache ändern, während Sie einen persistierten Speicherplatz Ihrer aktuellen Antworten haben, wird das Save-STATE entfernt.",
      ...
      legal: {
        ...
        subTitle: "Diese Links werden optional gerendert (kann über die Entwicklung-Konfiguration aktiviert werden).Der Textinhalt dieses Bildschirms kann über die Textkonfiguration aktualisiert werden",
        iconType: "entypo",
        iconTitle: "archive",
      },
    },
    ...
    survey: {
      ...
      noUserText: "Ihre ID konnte nicht überprüft werden.Bitte versuche es erneut.",
      welcomeTextFirstTimeUser2: "- Sehen?Dies ist der zweite Teil dieser Nachricht.",
      sendFinishedMessage: "Bestätigungsdialog zum Senden des ausgefüllten Fragebogens?",
      noNewQuestionnaireAvailableYetTitle: "Titel, falls kein Fragebogen verfügbar ist",
      sendUnfinishedMessageDenied: "Der aktuelle Fragebogen ist noch nicht abgeschlossen.Bitte tun Sie dies.",
      endedStudyText: "Diese Zeichenfolge enthält Informationen zum Ende der Studie für den Benutzer.",
      nextOne: "Dieser Text wird angezeigt, um zu kommunizieren, wenn der nächste Fragebogen verfügbar ist: ",
      noQuestionnaireText: "Beim Laden des Fragebogens trat ein Fehler auf - bitte versuchen Sie es erneut.",
      noNewQuestionnaireAvailableYet: "Dieser Text wird angezeigt, wenn im Moment kein Fragebogen verfügbar ist.",
      nextOneNew: "Dieser Text wird angezeigt, um einem neuen Benutzer zu kommunizieren, wenn der nächste Fragebogen verfügbar ist: ",
      furtherInfo: "Dies ist der untere Snippet des Welcometext.Sie können hier etwas nützliches platzieren ... wie ein Limerick.",
      welcomeTextUser: "Dies ist die regelmäßige Begrüßungsnachricht.Es wird angezeigt, wenn ein Fragebogen verfügbar ist und der Benutzer ein wiederkehrendes ist.Darunter sollte das Fälligkeitsdatum angezeigt werden.",
      welcomeTextFirstTimeUser1: "Dies ist Text, der an Erstzeitern dargestellt wird.Es sagt ihnen, wenn der erste Fragebogen fällig ist: ",
    },
    ...
    webViews: [
        ...
        subTitle: "Für jeden Artikel fügen Sie der Eigenschaft WebView von textconfig.js hinzu, ein anderer Eintrag in dieser Liste wird generiert.Auf diese Weise können Sie mehr Inhalte hinzufügen, indem Sie einfach eine Website hosten und Textconfig.js hinzufügen",
        screenSubTitle: "Untertitel dieses Bildschirms",
    ...
    modalLinks: [
        {
        title: "Erster Link",
        subTitle: "Dies ist ein regulärer Link.Es wird ein Modal eröffnet, bevor der Benutzer den Benutzer auf seinen eigenen Browser umleitet.",
        ...
        {
        title: "Zweiter Link",
        subTitle: "Für jeden Artikel fügen Sie der Eigenschaft Modulks von textconfig.js hinzu, ein anderer Eintrag in dieser Liste wird generiert.",
        text: "Ihre werden jetzt umgeleitet.",
        uri: "https://ibm.com/",
        iconTitle: "link",
        iconType: "entypo",

export default {
    ...
    accessibility: {
      ...
      refreshHint: "Obtenez le questionnaire et le statut neuf.La page actuelle est mise à jour.",
      ...
      accept: "J'accepte",
      cancel: "Avorter",
      acceptHint: "Passe à l'application de navigateur par défaut et ouvre un lien là-bas.",
  
      menu: "Information additionnelle",
      menuHint: "Ouvre une nouvelle page avec des informations supplémentaires et des liens.",
  
      logoutHint: "Démarre le processus de déconnexion et rediriger la page de connexion.",
      loginHint: "Démarrez le processus de connexion et redirige le scanner QRCode.",
  
      questionnaire: {
        middleButtonFinished: "Suivant question.EJECT sera répondu.",
        middleButtonUnfinished: "Question suivante, bien que la question ne soit pas encore répondue.",
        middleButtonHint: "Allez à la prochaine question ou ferme le modal si c'était la dernière question.",
  
        rightButtonHint: "Ferme le modal.",
        leftButtonHint: "Aller à la question précédente.",
        alertButtonHint: "Ferme l'alarme.",
  
        questionnaireCellHint: "Ouvre une nouvelle page pour afficher les catégories du questionnaire.",
        categoryCellHint: "Ouvre modal pour remplir cette entrée de questionnaire.",
        ...
        multipleChoice: "Choix multiple - Plus d'une option de réponse peut être sélectionnée.",
        singleChoice: "Choix individuel - Une seule option de réponse peut être sélectionnée.",
        ...
        triggerHint: "Si cet élément est sélectionné, une autre question supplémentaire est affichée, qui est connectée à cet élément. Veuillez remplir la question supplémentaire.",
      },
    },
    ...
    login: {
      ...
      permissionDialog: "Veuillez autoriser l'application à accéder à votre appareil photo.",
    ...
    generic: {
      ...
      sendError: "Il y avait une erreur qui transmet les données. Veuillez réessayer.",
      sendErrorTwoDevices: "Vous avez déjà envoyé ce questionnaire par une autre application.",
      eraseAllWarning: "Cela supprime toutes les données locales et le connecte. Voulez-vous faire une procédure?",
      eraseLocalDataAtEndOfStudyText: "Cela soulignera à nouveau la fin de l'étude. Sobald L'utilisateur confirme les données locales, le participant sera dérégué. Vous êtes tombé précédé?",
    ...
    about: {
      ...
      languageWarning: "Si vous modifiez la langue lorsque vous avez un état de sauvegarde persisté de vos réponses actuelles, ledit Save State sera supprimé.",
      languageWarningAddition: "\nVoulez-vous poursuivre?",
  
      /** contains the strings for the optional LegalInformation Screen */
      legal: {
        title: "Lien vers l'écran légal",
        subTitle: "Ces liens sont éventuellement rendus (peuvent être activés via la configuration de développement). Le contenu texte Cet écran peut être mis à jour via la configuration du texte.",
        iconType: "entypo",
        iconTitle: "archive",
      },
    },
    ...
    survey: {
      ...
      noUserText: "Votre identifiant n'a pas pu être vérifié. Veuillez réessayer.",
      welcomeTextFirstTimeUser2: "- Voir? Ceci est la deuxième partie de ce message.",
      sendFinishedMessage: "Dialogue de confirmation pour envoyer le questionnaire terminé?",
      noNewQuestionnaireAvailableYetTitle: "Titre Si aucun questionnaire n'est disponible",
      sendUnfinishedMessageDenied: "Le questionnaire actuel n'est pas encore terminé. S'il vous plaît faites cela.",
      endedStudyText: "Cette chaîne contient des informations sur la fin de l'étude pour l'utilisateur.",
      nextOne: "Ce texte est affiché pour communiquer lorsque le prochain questionnaire est disponible:",
      noQuestionnaireText: "Lors du chargement du questionnaire, une erreur s'est produite - veuillez réessayer.",
      noNewQuestionnaireAvailableYet: "Ce texte est affiché lorsqu'aucun questionnaire n'est disponible pour le moment.",
      nextOneNew: "Ce texte est affiché pour communiquer un nouvel utilisateur lorsque le prochain questionnaire est disponible:",
      furtherInfo: "C'est l'extrait inférieur du texte de bienvenue. Vous pouvez placer quelque chose d'utile ici ... comme un limérick.",
      welcomeTextUser: "C'est le message d'accueil régulier. Il apparaît lorsqu'un questionnaire est disponible et que l'utilisateur est récurrent. Darunder devrait afficher la date d'échéance.",
      welcomeTextFirstTimeUser1: "Ceci est un texte affiché sur les points d'extrémité. Il vous dit si le premier questionnaire est dû:",
    },
    ...
    webViews: [
        ...
        subTitle: "Ceci est un élément lisitem.\ n \ n Si cliquez sur, cet écartem ouvre l'écran WebView, ce qui rapportera un site Web dans l'application.",
        ...
        {
        title: "Autre webview.",
        subTitle: "Pour chaque article, ajoutez la propriété WebView à partir de textconfig.js, une autre entrée de cette liste est générée. De cette façon, vous pouvez ajouter plus de contenu en hébergeant simplement un site Web et ajouter textconfig.js",
        screenSubTitle: "Sous-titres de cet écran",
    ...
    modalLinks: [
        {
        title: "Premier lien",
        subTitle: "Ceci est un lien régulier. Un modal est ouvert avant que l'utilisateur redirige l'utilisateur sur son propre navigateur.",
        ...
        {
        title: "Deuxième lien",
        subTitle: "Pour chaque article, ajoutez la propriété textconfig.js à la propriété Moduleks, une autre entrée de cette liste est générée.",
        text: "Votre va maintenant être détourné.",
        uri: "https://ibm.com/",
        iconTitle: "link",
        iconType: "entypo",

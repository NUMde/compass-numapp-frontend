export default {
  ...
  accessibility: {
    ...
    loginHint: "يبدأ عملية تسجيل الدخول وإعادة التوجيه إلى ماسح رمز الاستجابة السريعة.",

    questionnaire: {
      middleButtonFinished: "السؤال التالي.يتم الرد على السؤال.",
      middleButtonUnfinished: "السؤال التالي، على الرغم من أن السؤال لم تتم الإجابة عليه بعد.",
      middleButtonHint: "يقفز إلى الأسئلة التالية، أو إغلاق المشرف إذا كان هذا هو السؤال الأخير.",
      ...
      triggerHint: "إذا تم تحديد هذا العنصر، فسيتم عرض سؤال إضافي آخر مرتبط بهذا العنصر.يرجى ملء السؤال الإضافي كذلك.",
    },
  },
  ...
  login: {
    ...
    landing: {
      ...
      autoLoginError: "حدث خطأ أثناء محاولة تسجيل الدخول تلقائيا.يرجى التحقق من شبكتك وحاول مرة أخرى",
      retry: "أعد",
    },
  },
  ...
  generic: {
    ...
    eraseAllWarning: "سيؤدي هذا إلى حذف جميع البيانات المحلية وتخرجك.هل تريد أن ترجم؟",
    eraseLocalDataAtEndOfStudyText: "هذا سوف يؤكد مرة أخرى نهاية الدراسة.بمجرد أن يؤكد المستخدم أن يتم إزالة البيانات المحلية وسيتم تسجيل المشارك.هل تريد أن تسبق؟",
    eraseLocalDataAtEndOfStudyTitle: "حذف البيانات والخروج المحلية",
    updateError: "حدث خطأ أثناء الحصول على البيانات المطلوبة - يرجى المحاولة مرة أخرى.",
    infoRemoval: "الاستبيان المستمر حاليا عفا عليه الزمن وسيتم إزالته الآن.",
    reportWhileInIteratedMode: "مربع الحوار لإخبار المستخدم بأنه أرسل بالفعل في تقرير خاص وأنه الآن على فاصل خاص.",
    reportWhileQuestionnaire: "مربع الحوار لإخبار المستخدم الذي يتوفر الاستبيان حاليا وأنه قد يستخدم هذا واحد للإبلاغ عن حالته.",
  },
  ...
  about: {
    ...
    languageWarning: "إذا غيرت اللغة أثناء وجود حالة حفظ إجاباتك الحالية، فسيتم إزالة حفظ الحالة المذكورة.",
    languageWarningAddition: "\nهل تريد المتابعة؟",

    /** contains the strings for the optional LegalInformation Screen */
    legal: {
      title: "رابط إلى شاشة ",
      subTitle: "يتم تقديم هذه الروابط اختياريا (يمكن تنشيطها من خلال التكوين التنموي).يمكن تحديث محتوى النص من هذه الشاشة من خلال تكوين النص",
      iconType: "entypo",
      iconTitle: "archive",
    },
  },
  ...
  survey: {
    ...
    noNewQuestionnaireAvailableYetTitle: "العنوان، في حالة عدم وجود استبيان متاح",
    sendUnfinishedMessageDenied: "لا يتم الانتهاء من الاستبيان الحالي بعد.يرجى القيام بذلك.",
    ...
    noQuestionnaireText: "حدث خطأ أثناء تحميل الاستبيان - يرجى المحاولة مرة أخرى.",
    noNewQuestionnaireAvailableYet: "سيتم عرض هذا النص إذا لم يتوفر أي استبيان الآن.",
    nextOneNew: "سيتم عرض هذا النص للتواصل مع مستخدم جديد عند توفر الاستبيان التالي: ",
    furtherInfo: "هذا هو المقتطف السفلي من الترحيل.قد تضع شيئا مفيدا هنا ... مثل نكتة.",
    welcomeTextUser: "هذه هي رسالة الترحيب العادية.سيتم عرضه إذا كان الاستبيان متاحا ومستخدم واحد متكرر.أسفل هذا، يجب عرض تاريخ الاستحقاق.",
    welcomeTextFirstTimeUser1: "هذا هو النص الذي يتم تقديمه للمستخدمين لأول مرة.يخبرهم عندما يكون الاستبيان الأول مستحقا: ",
  },

...
export default {
	...
	"generic":{
		...
		"eraseAllWarning":"This will delete all local data and logs you out. Do you want to precede?",
	...
	"survey":{
		...
		"endedStudyText":"This string will hold information about the end of the study for the user.",

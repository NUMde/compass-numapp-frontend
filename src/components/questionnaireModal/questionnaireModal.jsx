...
class QuestionnaireModal extends Component {
  ...
  /**
   * handles the event triggered by pressing the back button of the modal
   */
  handleBackPress = () => {
  ...
  /**
   * handles the event triggered by pressing the middle/forward button of the modal
   */
  handleForwardPress = () => {
    const { actions, categories, currentCategoryIndex, currentPageIndex } =
      this.props;
    setAccessibilityResponder(this.modalTitleRef);
    this.lastPageNavigationWasForwards = true;
    actions.switchContent(
    ...
    if (typeof this.props.currentCategoryIndex === 'number') {
      ...
      return (
        <RNModal
          ...
          onModalWillHide={() =>
            exportService.checkCompletionStateOfMultipleItems(null, this.props)
          }
        >
          ...
          <BottomBar
            ...
            completed={this.checkCurrentPageState()}
 ...
 * @param {Boolean} props.completed whether the current page is completed
    ...
    >
      ...
      <View style={localStyle.bottomBarButtons}>
        ...
        <Button
          ...
          disabledStyle={localStyle.disabledButton}
